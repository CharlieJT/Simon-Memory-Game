...
- Players immediately experience a clear, easy and intuitive feel for the game right away. Simple controls which allow the player to have an easy understanding of how to play the game. Should the player be confused at any point, a 'Game-Info' box
...
The design of the game is intended to replicate the orginal 1978 Simon Game with a slightly modernized touch to it.
...
- #### Colours
    ...
    - **Main Heading and Footer -** A font of white was chosen to contrast nicely with the background of the webpage.
    A background colour of white opaque was chosen to indicate the header & footer fields as wel as still showing the background.
    ...
    to ensure eveything is easily displayed.
